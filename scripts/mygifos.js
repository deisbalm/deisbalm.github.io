                    ...
                    <div class="gif-acciones-resultados-misgifos">
                        <div class="iconos-acciones-gif">
                            <button class="iconos-acciones-box borrar" onclick="borrarGifo('${content.data[i].id}')">
                                <img src="./images/icon_trash.svg" alt="icon-borrar">
                            </button>
...
function maxGifMobileMG(img, id, slug, user, title) {
    ...
    <button class="modal-btn-close" onclick="cerrarModalMobileMG()"><img src="./images/button-close.svg" alt=""></button>
    ...
    <div class="modal-bar">
        ...
        <div>
            <button class="modal-btn" onclick="borrarGifo('${id}')"><img src="./images/icon_trash.svg" alt="delete-gif"></button>
...
function maxGifDesktopMG(img, id, slug, user, title) {
    ...
    <button class="modal-btn-close" onclick="cerrarModalDesktopMG()"><img src="./images/button-close.svg" alt=""></button>
    <img src="${img}" alt="${id}" class="modal-gif">
